...
// https://stackoverflow.com/questions/3144044/calculating-the-bounding-box-using-javascript
LatLon.prototype.boundingBox = function (distance)
{

    var left = this.destinationPoint(-90, distance).lon;
    var top = this.destinationPoint(180, distance).lat;
    var right = this.destinationPoint(90, distance).lon;
    var bottom = this.destinationPoint(0, distance).lat;
